...
* `report`: Generate diagnostic plots and HTML report...
* `report-view`: Launch the interactive report viewer.
...
* `--spatial-neighbors INTEGER RANGE`: k1: Number of spatial neighbors in it&#x27;s own slice for spatial dataset  [default: 201; 10&lt;=x&lt;=5000]
...
* `--rank-read-workers INTEGER RANGE`: Number of parallel reader threads for rank memory map  [default: 10; 1&lt;=x&lt;=16]
* `--mkscore-compute-workers INTEGER RANGE`: Number of parallel compute threads for marker score calculation  [default: 4; 1&lt;=x&lt;=16]
* `--mkscore-write-workers INTEGER RANGE`: Number of parallel writer threads for marker scores  [default: 4; 1&lt;=x&lt;=16]
...
* `--downsampling-n-spots INTEGER RANGE`: Number of spots to downsample for PCC calculation if n_spots &gt; this value  [default: 20000; 1000&lt;=x&lt;=100000]
